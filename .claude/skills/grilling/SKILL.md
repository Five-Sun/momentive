---
name: grilling
description: Grill the user relentlessly about a plan, decision, or idea. Use when the user wants to stress-test their thinking, or uses any 'grill' / '그릴' trigger phrases (e.g. "grill me", "grill this plan").
---
...
Once the user confirms shared understanding, write it down as a spec:
